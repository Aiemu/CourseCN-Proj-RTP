...
class Client:
    ...
    def createWidgets(self):
        ...
        self.page_main.pushButton.clicked.connect(lambda: self.setFull())
        self.page_main.scrollLine.sliderMoved.connect(lambda: self.relocateMovie())
